...
# PUBLICADOR ENTRADA PARA EL WALLMART EL HATILLO
...
def main():
	...
	#Información del publicador
	  #Cliente
	client = paho.mqtt.client.Client("Entrada_El_Hatillo", False)
	...
	query = """SELECT fecha_entrada FROM visita WHERE id_sucursal = 2 ORDER BY ID DESC LIMIT 1;"""
	...
	while(True):
		...
		for persona in personas:
			...
			#Canal
			client.publish('Wallmart/El_Hatillo',json.dumps(persona),qos=0)	
